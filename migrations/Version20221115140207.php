 ...
 */
final class Version20221115140207 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE command ADD CONSTRAINT FK_8ECAEAD452569371 FOREIGN KEY (ligne_com_id) REFERENCES ligne_com (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD52569371 FOREIGN KEY (ligne_com_id) REFERENCES ligne_com (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
